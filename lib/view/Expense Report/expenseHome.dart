...
class ExpenseReportHome extends StatefulWidget {
  const ExpenseReportHome({super.key});

  @override
  State<ExpenseReportHome> createState() => _ExpenseReportHomeState();
}

class _ExpenseReportHomeState extends State<ExpenseReportHome> {
var controller = Get.put(CreditReportContoller());
  ...
  refreshData() {
    controller.getExpenseList(context);
  }
  @override
